...
export default function SubmitRestaurant() {
    ...
    const{resName,location,distance,priceCat} = restaurant;
    ...
    function handleSubmit (e) { 
        ...
        if(restaurant.resName=== "" || restaurant.resName === undefined){
            toast.error('Error: Restaurant Name cannot be empty.',{containerStyle: { width: '150%'}});
            return;
        }else if(restaurant.location=== "" || restaurant.location === undefined){
            toast.error('Error: Restaurant Location cannot be empty.',{containerStyle: { width: '100%'}});
            return;
